...
class Database{
	...
	private $db_user = "id3134772_usrrepartidor";  // Change as required
	private $db_pass = "rep-av-141026";  // Change as required
	private $db_name = "id3134772_aquavital";	// Change as required
