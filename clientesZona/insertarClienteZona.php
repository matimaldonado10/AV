...
class insertarClienteZona
{
	...
	public function insertarClienteEnZona($Orden, $idCliente, $dniCliente,
								$idZonaReparto)
	{
		$db = new Database();
		$db->connect();
		...
		$db->insert('clientesdirectos__zonadereparto', array(
			    'ClientesDirectos_Persona_IdCliente' => $idCliente,
			  'ClientesDirectos_Persona_DNICliente' => $dniCliente,
		'ZonaDeReparto_idRutaDeReparto' => $idZonaReparto, 'Orden' => $Orden));
