...
class tablas
{
	...
	public function obtenerClientesDeRepartidor($dni)
	{
		...
		$db->select('zonadereparto','DISTINCT clientesdirectos__zonadereparto.ClientesDirectos_Persona_IdCliente, clientesdirectos__zonadereparto.ClientesDirectos_Persona_DNICliente, persona.Apellido, persona.Nombre, persona.Telefono, persona.Email, direccion.Direccion, direccion.Referencia, barrio.Barrio','clientesdirectos__zonadereparto JOIN persona JOIN direccion JOIN barrio','zonadereparto.Repartidor_Persona_DNIRepartidor="'.$dni.'" AND clientesdirectos__zonadereparto.ZonaDeReparto_idRutaDeReparto= zonadereparto.idRutaDeReparto and clientesdirectos__zonadereparto.ClientesDirectos_Persona_IdCliente = persona.IdPersona AND clientesdirectos__zonadereparto.ClientesDirectos_Persona_DNICliente = persona.DNI AND direccion.Persona_IdPersona=persona.IdPersona AND direccion.Persona_DNI=persona.DNI and barrio.IdBarrio=direccion.Barrio_IdBarrio');
