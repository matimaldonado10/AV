...
class rutaOptima
{
    private $__arrayDatosOsrm;

    private $__arrayDeClientesDeRepartidoresEnUnDia;

    // Tiene todos los datos de los repartidores y sus clientes
    private $__arrayRepartidores;

    private $__cantidadDepositos;

    private $__directorioDelDataSetAGenerar;

    private $__nombreDataSet;
...
$listaDeCoordenadasClientesOrdenada = $rutaOptima->
                            enviarDataSetAOptaplannerParaOptimizacionDeRutas();

$rutaSolucion = $rutaOptima->solicitarEnrutamientoOsrm(
                $listaDeCoordenadasClientesOrdenada );
