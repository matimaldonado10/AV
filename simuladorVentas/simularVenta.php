...
for ( $i = 0; $i < count( $registrosRepartidores ) - 1; $i++ ) {
	...
	$idSupervisor =
		$registrosSupervisores[$filaSupervisor]["Persona_IdSupervisor"]
	;
	$dniSupervisor =
		$registrosSupervisores[$filaSupervisor]["Persona_DNISupervisor"
	];
...
// Cuántas cargas realiza el repartidor?
	...
	$descarga->cargasDescargas( $idSupervisor, $idRepartidor,
		$dniSupervisor
		,
		$dniRepartidor, $fecha, $cantidadCargas, $registrosArticulos );
